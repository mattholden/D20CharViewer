...
public class D20RacePage extends WizardPageActivity<D20Character> {
	...
	public void doCreate() {
		...
		setContentView(R.layout.d20race);
			
		Spinner spinner = (Spinner) findViewById(R.id.d20race_race);
	...
	public void d20race_srd(View v) { 
		Spinner spinner1 = (Spinner) findViewById(R.id.d20race_race);
